...
class TestKv(unittest.TestCase):
    ...
    def test_5(self):
     """Тест для вырожденного случая (вертикальная линия)"""
         a, b, c = 0, 0, 5
         res = cvyr(a, b, c)
         self.assertEqual(res, "Выраженный случай, уравнение не имеет решения", 
                     "Неверный результат для вырожденного случая")
